package com.game.player.two.kafka.impl;
...
public class KafkaConsumer {
  ...
  public void listenMessage(GameEvent gameEvent) {
    ...
    if (isFinished) {
      log.info("PLAYER TWO YOU HAVE LOST THE GAME");
      eventPublisher.flush();
    } else {
      if (pass == 1) {
        log.info("PLAYER TWO YOU HAVE WON THE GAME");
        ...
        log.info("PLAYER TWO SENDING NEXT NUM {}", next);
